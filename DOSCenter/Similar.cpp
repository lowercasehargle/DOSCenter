// Similar.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CSimilar, CWnd)
CSimilar::CSimilar()
{
}
...
BEGIN_MESSAGE_MAP(CSimilar, CWnd)
END_MESSAGE_MAP()



// CSimilar message handlers

/* Quick and dirty swap of the address of 2 arrays of unsigned int
*/
void CSimilar::swap( unsigned **first, unsigned **second)
{
	unsigned *temp;
	temp=*first;
	*first=*second;
...
*/
float CSimilar::simil( char *str1, char *str2)
{
...
*/
char* CSimilar::LCS( char *str1, char *str2)
{
